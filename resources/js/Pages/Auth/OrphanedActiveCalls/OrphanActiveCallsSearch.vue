...
const submit = () => {
    ...
    form.get(route('web.orphan-active-calls.index'), {
        preserveScroll: true
    });
};
...
<template>
    <LayoutBox>
        <SearchContainer heading="Search Orphaned Active Calls" storage-key="hide_orphan_active_search_search_panel">
            <form @submit.prevent="submit">
                <div class="grid grid-cols-12 gap-x-4 gap-y-1">
                    <Select label="Organisation"
                            name="organisation"
                            tip="The organisation the orphan call belongs to."
                            :has-default="true"
...
<!--                    <Select label="Status"-->
<!--                            name="drawn"-->
<!--                            tip="If this participant has been included in a draw."-->
<!--                            :has-default="true"-->
<!--                            :options="[{label:'True', value:true},{label:'False', value:false}]"-->
<!--                            v-model="form.drawn"-->
<!--                            class="col-span-12 sm:col-span-12 xl:col-span-4"-->
<!--                    ></Select>-->

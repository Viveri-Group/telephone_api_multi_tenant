    ...
    <div>
        <div class="border border-gray-100 xl:border-none rounded-lg px-0 text-sm"
            ...
            <div class="xl:hidden flex justify-between bg-gray-100 p-2 rounded-t-lg">
                <p class="ml-auto text-gray-600 text-sm" v-text="'ID: ' + props.orphan.id"></p>
            </div>
            ...
            <div class="grid grid-cols-3 xl:grid-cols-12 gap-y-2 xl:gap-4 px-4 xl:px-2 py-4 xl:py-2"
                ...
                <div class="hidden xl:inline-block col-span-2 xl:col-span-2 gap-2 text-gray-400 text-xs">
                    <p class="text-sm" v-text="'ID: ' + props.orphan.id"></p>
                    ...
                    <CopyToClipboard
                        ...
                        :button-title="'Call ID: '+props.orphan.call_id"
                        :copy="props.orphan.call_id">
                    </CopyToClipboard>
                </div>
                ...
                <div class="col-span-2 xl:col-span-3 xl:text-center text-left">
                    ...
                    <DateFormatter :date="props.orphan.created_at" format="do MMM yyyy HH:mm:ss"></DateFormatter>
                </div>
            </div>
        </div>
    </div>
